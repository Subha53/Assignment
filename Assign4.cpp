...
public:
    ...
    {
        cout << endl
             << "*********Set the username and password*********" << endl;
        ...
        cout << "You have successfully signed up" << endl
             << endl;
        cout << endl
             << "Welcome to Library of Congress." << endl;
    }
};
...
public:
    issueB(int booksIssued)
    {
        ...
        else
        {
            ...
            cout << endl;
            cout << endl
            << "You have successfully issued the book." << endl;
            cout << endl
            << "You can still issue " << 5 - booksIssued << " number of books" << endl
            << endl;
    ...
    issueB()
    {
        if (booksIssued > maxBook)
            booksIssued = 5;
            cout << endl
             << "Number of books currently issued by you: " << booksIssued << endl;
             cout << "Amount to pay: " << Due << "Rs." << endl;
             cout << "Number of books to be returned: " << booksReturn << endl;
    }
    friend int get();
...
{
    cout << endl
    << "Sorry! You have reached the limit!. Return some books to issue new one. Thank You!" << endl;
}
    ...
    int display()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                cout << endl
                 << "You have"
                 << " " << booksReturn << " books in your account." << endl;
            }
        }
        catch (int a)
        {
            ...
            cout << endl
                 << "Error!"
                 << " "
                 << "There are " << a << " books in your account to return." << endl;
        }
    }
};
...
int main()
{
    ...
    while (1)
    {
        ...
        switch (choice)
        {
           ...
           case 4:
           cout << endl
           << "Thank You for using our Library. Hope you have enjoyed our service." << endl;
